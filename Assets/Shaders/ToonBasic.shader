...
////// Emissive:
                ...
                float4 node_17 = tex2D(_MainTex,TRANSFORM_TEX(node_76.rg, _MainTex));
...
////// Lighting:
                ...
                float4 node_17 = tex2D(_MainTex,TRANSFORM_TEX(node_77.rg, _MainTex));

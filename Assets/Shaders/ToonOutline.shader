...
////// Emissive:
                ...
                float4 node_17 = tex2D(_MainTex,TRANSFORM_TEX(node_50.rg, _MainTex));
...
////// Lighting:
                ...
                float4 node_17 = tex2D(_MainTex,TRANSFORM_TEX(node_51.rg, _MainTex));

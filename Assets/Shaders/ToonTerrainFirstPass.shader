...
Shader "Dissertation/ToonTerrainFirstPass" {
    Properties {
...
/// Final Color:
	...
	Dependency "AddPassShader" = "Dissertation/ToonTerrainAddPass"
	Dependency "BaseMapShader" = "Dissertation/ToonTerrainBaseMap"
    FallBack "Diffuse"

...
public class CameraController : MonoBehaviour
{
    ...
    float angularSmoothLag = 0.1f;
    float angularMaxSpeed = 128.0f;
    ...
    private void SetUpRotation(Vector3 centerPos, Vector3 headPos)
    {
        ...
        Ray topRay = cameraTransform.GetComponent<Camera>().ViewportPointToRay(new Vector3(0.5f, clampHeadPositionScreenSpace, 1.0f));

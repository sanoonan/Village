...
public class PlaylistController : MonoBehaviour
{
    ...
    private void PlaySong(MusicSetting setting)
    {
        ...
        if (currentPlaylist != null) {
			...
			if (currentPlaylist.songTransitionType == MasterAudio.SongFadeInPosition.NewClipFromBeginning && setting.customStartTime > 0f) {
				audioClip.timeSamples = (int) (setting.customStartTime * audioClip.clip.frequency);
			}
        }

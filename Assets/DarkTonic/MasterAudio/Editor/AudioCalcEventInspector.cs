...
public class AudioCalcEventInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (newSpawnMode != sounds.soundSpawnMode) {
            UndoHelper.RecordObjectPropertyForUndo(ref isDirty, sounds, "change Spawn Mode");
        ...
        if (aud == null || aud.clip == null) {
            ...
            if (newAudioEnded != sounds.useAudioSourceEndedSound) {
                UndoHelper.RecordObjectPropertyForUndo(ref isDirty, sounds, "toggle Audio  Source Ended");
